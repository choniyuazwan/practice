...
public class MahasiswaMainList {
	public static void main(String[] args) {
		...
		// Print Header Table
		System.out.println("| " + padRight("No", 3) + "| " 
				+ padRight("NIM", 8) + "| " + padRight("Full Name", 20) + "| " 
				+ padRight("Tugas", 3) + "|"
				+ padRight("UPM", 3) + "|"
				+ padRight("UAS", 3) + "|"
				+ padRight("Rata-rata", 3) + "|"
				+ padRight("Grade", 3) + "|");
		...
		for (Mahasiswa2 mahasiswa2 : listMhs) {
			...
			// Get nilai rata-rata
			double rataSiswa = siswaService.getAverage(mahasiswa2.getTugas1(), mahasiswa2.getTugas2(), mahasiswa2.getUpm(), mahasiswa2.getUas());
			...
			System.out.println("|" + padRight("" + i, 3) + "| " + padRight(mahasiswa2.getNim(), 8) + "| " 
				    ...
				    + padRight("" + mahasiswa2.getUpm(), 3) + "|"
				    + padRight("" + mahasiswa2.getUas(), 3) + "|"
				    + padRight("" + rataSiswa, 3) + "|"
				    + padRight("" + siswaService.getGrade(rataSiswa), 3) + "|");
